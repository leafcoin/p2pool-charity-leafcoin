...
nets = dict(
    ...
    leafcoin=math.Object( 
        ...
        TARGET_LOOKBEHIND=20, # shares coinbase maturity
        SPREAD=50, # blocks
        IDENTIFIER='fc756177736f696e'.decode('hex'),
        PREFIX='fe636f696e6c657a'.decode('hex'),
        P2P_PORT=8166,
        MIN_TARGET=0,
        MAX_TARGET=2**256//2**20 - 1,
        PERSIST=False,
        ...
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: True,
	 CHARITY_ADDRESS='abe20097fd1476fba24e6e87b2f31da2196cdb88'.decode('hex'),
        CHARITY_VALUE=50,
    ),

    leafcoin_testnet=math.Object(
        PARENT=networks.nets['leafcoin_testnet'],
        SHARE_PERIOD=10, # seconds target spacing
        CHAIN_LENGTH=12*60*60//10, # shares
        REAL_CHAIN_LENGTH=12*60*60//10, # shares
        TARGET_LOOKBEHIND=20, # shares coinbase maturity
        SPREAD=50, # blocks
        IDENTIFIER='fc856177736f696e'.decode('hex'),
        PREFIX='fe636f696e6c658a'.decode('hex'),
        P2P_PORT=8166,
        MIN_TARGET=0,
        MAX_TARGET=2**256//2**20 - 1,
        PERSIST=False,
        ...
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: True,
	 CHARITY_ADDRESS='4CDF68D16237578C9F5A1E8429622A833B1BCC76'.decode('hex'),
        CHARITY_VALUE=50,
    ),
    ekrona=math.Object(
